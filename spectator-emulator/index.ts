// ts-node tools/spectator-emulator/index.ts ../temp/replays/replay_file.rlp.json

import { bufferToArrayBuffer } from '@repo/gameserver/src/core/logging';
...
import _replayreaders from '../server/_replayreaders/index';
